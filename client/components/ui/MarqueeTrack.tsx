...
const SpringBootIcon = memo(() => (
  (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 510 458">
    <path fill="currentColor" d="
      M503.5 201.4
      L403 27.5
      c-8.7-15.1-30.1-27.5-47.6-27.5H154.6
      c-17.4 0-38.9 12.4-47.6 27.5L6.6 201.4
      c-8.7 15.1-8.7 39.8 0 54.9l100.4 174
      c8.7 15.1 30.1 27.5 47.6 27.5h200.9
      c17.4 0 38.8-12.4 47.6-27.5l100.4-174
      c8.7-15.1 8.7-39.8 0-54.9z

      M233.3 96.2
      c0-11.4 9.3-20.7 20.7-20.7s20.7 9.3 20.7 20.7
      v123.7c0 11.4-9.3 20.7-20.7 20.7
      s-20.7-9.3-20.7-20.7V96.2z

      M254 340.3
      c-77.4 0-140.4-63-140.4-140.4
      c0-44.4 21.1-86.1 56.7-112.7
      c8.2-6.1 19.7-4.4 25.8 3.8
      s4.4 19.7-3.8 25.8
      c-45.9 34.1-55.5 99-21.4 144.9
      s99 55.5 144.9 21.4
      c26.3-19.5 41.8-50.4 41.8-83.2
      c0-32.9-15.7-63.8-42.2-83.4
      c-8.2-6-9.9-17.6-3.9-25.8
      s17.6-9.9 25.8-3.9
      c35.9 26.5 57 68.5 57.1 113.1
      c0 77.5-63 140.4-140.4 140.4z
    "/>
  </svg>)
))
...
const animationMap: { [key: string]: string } = {
    frontend: "animation-marquee-frontend",
    backend: "animation-marquee-backend",
    database: "animation-marquee-database"

}

const marqueeGlowMap: { [key: string]: string } = {
  frontend: "rgba(97,218,251,0.35)",
  backend: "rgba(109,179,63,0.35)",
  database: "rgba(51,103,145,0.35)"
}
          ...
          <HoverCard key={`real-${index}`}>
            <HoverCardTrigger>
              <div className="shrink-0">
                  <MarqueeTechPill name={tech.name} icon={tech.icon} glow={tech.glow}/>
              </div>
            </HoverCardTrigger>
            <HoverCardContent  side="top" className="w-72 flex flex-col rounded-2xl bg-background/70 border border-[#FFFFFF14] gap-2 text-[#94A3B8] shadow-[0_0_10px_var(--glow)]"
              style={{ "--glow": tech.glow } as React.CSSProperties}>
              <div>
                <div className="font-semibold">Projects used in:</div>
                <hr></hr>
              </div>
              <ul>
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                Click one of the projects above to see more!
              </div>
            </HoverCardContent>
          </HoverCard>
        ))}
